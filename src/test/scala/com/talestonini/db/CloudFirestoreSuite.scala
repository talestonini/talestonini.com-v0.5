...
class CloudFirestoreSuite extends CatsEffectSuite {
  ...
  test("get a post") {
    ...
    CloudFirestore.getDocumentsF[Post](getTestToken(), postsPath) flatMap { posts =>
  ...
  test("create a comment") {
    ...
    CloudFirestore.upsertDocumentF[Comment](getTestToken(), niceCommentPath, niceComment) flatMap { comment =>
  ...
  test("get a comment") {
    CloudFirestore.getDocumentsF[Comment](getTestToken(), scalaDecoratorsCommentsPath) flatMap { comments =>
  ...
  test("delete a comment") {
    CloudFirestore.deleteDocumentF[Comment](getTestToken(), niceCommentPath) flatMap { response =>
